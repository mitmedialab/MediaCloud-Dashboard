        ...
        this.tagModels = [
            new App.TagModel({
                ...
                description: 'A combination of our '
                    ...
                    +" , "+'<a target=_new href="'+App.getSourcesUrl('media-tag',8875109)+'">Liberal Political Blogs</a>'
                    +" , "+'<a target=_new href="'+App.getSourcesUrl('media-tag',8875111)+'">Conservative Political Blogs</a>'
                    +" , and "+'<a target=_new href="'+App.getSourcesUrl('media-tag',8878294)+'">Libertarian Sources</a> collections.',
                "tags": [
